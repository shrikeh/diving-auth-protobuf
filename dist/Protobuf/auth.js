...
$root.auth = function () {
  ...
  auth.EncryptedCredentials = function () {
    ...
    EncryptedCredentials.encode = function encode(message, writer) {
      ...
      if (message.credentials != null && Object.hasOwnProperty.call(message, "credentials")) writer.uint32(
      /* id 1, wireType 2 =*/
      10).string(message.credentials);
      return writer;
    };
    /**
    ...
    EncryptedCredentials.decode = function decode(reader, length) {
      ...
      var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.auth.EncryptedCredentials();
    ...
    EncryptedCredentials.verify = function verify(message) {
      ...
      if (message.credentials != null && message.hasOwnProperty("credentials")) if (!$util.isString(message.credentials)) return "credentials: string expected";
      return null;
    };
    /**
    ...
    EncryptedCredentials.fromObject = function fromObject(object) {
      if (object instanceof $root.auth.EncryptedCredentials) return object;
      var message = new $root.auth.EncryptedCredentials();
      if (object.credentials != null) message.credentials = String(object.credentials);
      return message;
    };
    /**
    ...
    EncryptedCredentials.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.defaults) object.credentials = "";
      if (message.credentials != null && message.hasOwnProperty("credentials")) object.credentials = message.credentials;
      return object;
    };
    /**
  ...
  auth.BearerToken = function () {
    ...
    BearerToken.encode = function encode(message, writer) {
      ...
      if (message.expiry != null && Object.hasOwnProperty.call(message, "expiry")) $root.google.protobuf.Timestamp.encode(message.expiry, writer.uint32(
      /* id 2, wireType 2 =*/
      18).fork()).ldelim();
      return writer;
    };
    ...
    BearerToken.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.auth.BearerToken();
    ...
    BearerToken.fromObject = function fromObject(object) {
      if (object instanceof $root.auth.BearerToken) return object;
      var message = new $root.auth.BearerToken();
      if (object.token != null) message.token = String(object.token);

      if (object.expiry != null) {
        if ((0, _typeof2.default)(object.expiry) !== "object") throw TypeError(".auth.BearerToken.expiry: object expected");
    ...
    BearerToken.toObject = function toObject(message, options) {
      ...
      if (message.expiry != null && message.hasOwnProperty("expiry")) object.expiry = $root.google.protobuf.Timestamp.toObject(message.expiry, options);
      return object;
    };
    /**
